...
SELECT pg_catalog.setval('public.cast_ethnicities_id_seq', 230, true);
...
SELECT pg_catalog.setval('public.cast_races_id_seq', 90, true);
...
SELECT pg_catalog.setval('public.media_genres_id_seq', 19, true);
