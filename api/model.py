...
class Country(db.Model):
    ...
    births = db.relationship("CastMember", back_populates="country_of_birth")
...
class AltCountry(db.Model):
    ...
    country = db.relationship("Country", uselist=False, back_populates="alt_names")
...
class Gender(db.Model):
    ...
    cast_member = db.relationship("CastMember", back_populates="gender")
...
class Ethnicity(db.Model):
    ...
    alt_names = db.relationship("AltEthnicity", back_populates="ethnicity")
...
class AltEthnicity(db.Model):
    ...
    ethnicity = db.relationship("Ethnicity", uselist=False, back_populates="alt_names")
...
class Race(db.Model):
    ...
    cast = db.relationship("CastMember", secondary="cast_races", back_populates="races")
...
class SourceLink(db.Model):
    ...
    cast_ethnicities = db.relationship(
        "CastEthnicity",
        secondary="cast_ethnicity_source_links",
