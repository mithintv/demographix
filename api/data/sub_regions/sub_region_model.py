...
class SubRegion(db.Model):
    ...
    region: Mapped[list[Region]] = relationship("Region", back_populates="subregions")
    countries: Mapped[list[Country]] = relationship("Country", back_populates="subregion")
    ethnicities: Mapped[list[Ethnicity]] = relationship("Ethnicity", back_populates="subregion")
