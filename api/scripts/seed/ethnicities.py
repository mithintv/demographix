ethnicities: list[str | dict[str, str]] = [
    "Abruzzi",
    "Acadian/Cajun",
    "Aden",
    "Afghan/Afghanistani",
    ...
    "Florida",
    "Formosan",
    {"name": "French", "region": "Europe", "subregion": "Western Europe"},
    "French Basque",
    "French Canadian",
    "French Samoan",
    "French West Indies",
    ...
    "Iranian",
    "Iraqi",
    "Irish/Northern Irish/Irish Protestant",
    "Iroquois",
    "Israeli",
    "Issei",
    "Italian",
    ...
    "Javanese/Java/Jawa",
    "Jebel Druse",
    "Jewish/Jew/Ashkenazi Jewish/Sephardic Jewish",
    "Jordanian",
    "Kalmyk",
    "Kansas",
    "Kapinagamarangan",
    ...
    "Pashtun/Pathan",
    "Pennsylvania German",
    {"name": "Persian", "subregion": "Western Asia"},
    "Peruvian",
    "Phoenix Islander",
    "Piedmontese",
    "Pima",
